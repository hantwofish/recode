...
%\usepackage[hyphenbreaks]{breakurl} % ben鰐igt f黵 das Brechen von URLs in Literaturreferenzen, hyphenbreaks auch bei links, die 黚er eine Seite gehen (mit hyphenation).
\usepackage{xcolor}
